...
%         \] یعنی اعداد زوج، با همان عمل جمع، یک زیرگروه از \( \mathbb{Z} \) است، بنابراین:
%         \[
...
%     \begin{talert}{}
%         \begin{align*}
%             (\mathbb{Z}, +)       & \quad  \leqslant  \quad(\mathbb{Q}, +)                                       \\
%             (\mathbb{Q}, +)       & \quad \leqslant   \quad(\mathbb{R}, +)                                       \\
%             (\mathbb{Q}^*, \cdot) & \quad  \leqslant  \quad(\mathbb{R}^*, \cdot)                                 \\
%             (M_n(\mathbb{Q}), +)  & \quad \leqslant   \quad(M_n(\mathbb{R}), +)                                  \\
%             (\mathbb{C}, +)       & \quad             \quad\text{(گروه جمعی اعداد مختلط)}                        \\
%             (\mathbb{C}^*, \cdot) & \quad             \quad\text{(گروه ضربی اعداد مختلط ناصفر)}                  \\
%             (M_n(\mathbb{C}), +)  & \quad             \quad\text{(گروه ماتریس‌های \( n \times n \) مختلط با جمع)}
%         \end{align*}
%     \end{talert}
% \end{frame}
